...
const ContactUs = () => {
  ...
  const onSubmit = async (data) => {
    ...
    var payload = {
      ...
      subject: "You have a new message from BIIRONIX TECH Website",
      body: emailBody,
    };
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Get in touch with BIIRONIX TECH for your IT needs. We are here to help you with App Development, Web Development, and AI Solutions."
        keywords="Contact BIIRONIX TECH, IT Support, Software Development Contact, AI Consultation"
      />
      <Banner page="Contact Us" />
      <div className="wrapper py-[5rem] grid lg:grid-cols-[45%_auto] gap-7">
        <div
          data-aos="fade-right"
          className="bg-gradient-to-br flex flex-col gap-2 text-white from-gray-900 to-black p-8 rounded-xl shadow-2xl border border-gray-800"
        >
          <div className="gradient-rounded-text-box border-gray-600 bg-gray-800/50">Contact Us</div>
          <h2 className="heading-2 mt-5 text-white">Get in Touch</h2>
          <p className="desc !text-gray-300">
            Let BIIRONIX TECH be the catalyst for your digital
          ...
          >
            ...
            <div className="flex flex-col h-full">
              ...
              <p className="desc !text-white/90">{companyDetails.phone}</p>
            </div>
          </Link>
          <Link
          ...
          >
            ...
            <div className="flex flex-col h-full">
              ...
              <p className="desc !text-white/90">{companyDetails.email}</p>
            </div>
          </Link>
          <div className="flex items-start gap-3 w-fit mt-5">
            ...
            <div className="flex flex-col h-full">
              ...
              <p className="desc !text-white/90 max-w-[20rem]">{companyDetails.address}</p>
            </div>
          </div>
        </div>
        <div
