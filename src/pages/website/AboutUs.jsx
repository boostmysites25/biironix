...
const AboutUs = () => {
  return (
    <>
      <SEO
        title="About Us"
        description="Learn about BIIRONIX TECH, our mission, vision, and the team driving innovation in AI and IT solutions."
        keywords="About BIIRONIX TECH, IT Company Mission, AI Innovators, Tech Team"
      />
      <div
        data-aos="fade-down"
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="">
                ...
                >
                  At BIIRONIX TECH, we specialize in crafting
