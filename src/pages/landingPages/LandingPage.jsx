...
export const LandingPage = ({ page }) => {
  ...
  return (
    <>
      <SEO
        title={isWebDevelopment ? "Web Development Services" : "App Development Services"}
        description={
          isWebDevelopment
            ? "Building Websites That Leverage AI to Define Your Brand's Digital Presence."
            : "Harnessing AI to Transform Your Ideas into Engaging Mobile Experiences."
        }
        keywords={
          isWebDevelopment
            ? "Web Development, Custom Websites, AI Websites, E-commerce Development"
            : "App Development, Mobile Apps, iOS Development, Android Development, AI Apps"
        }
      />
      <div id="banner" className="h-screen relative">
        ...
        >
          <div className="relative z-10 px-6 justify-center h-full flex flex-col items-center gap-5 text-center md:max-w-[60rem] mx-auto">
            ...
            <p className="!text-white/80 desc font-medium">
        ...
        <div className="wrapper">
          <div className="h-full grid md:grid-cols-2 gap-10 py-5">
            <div className="flex flex-col gap-4">
              ...
              <p className="desc">
                Get in touch with{" "}
                <span className="font-semibold">BIIRONIX TECH </span>
