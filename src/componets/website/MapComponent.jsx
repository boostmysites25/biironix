...
const MapComponent = () => {
  ...
  // 14.7637093485894, 78.557651269031;
  const location = useMemo(() => [14.7637093485894, 78.557651269031], []);
  ...
  return (
    ...
    >
      ...
      <Marker position={location}>
        <Popup>3/413, SAI KUTEER ROAD, Proddatur, Cuddapah, Andhra Pradesh, 516360.</Popup>
      </Marker>
    </MapContainer>
  );
};
