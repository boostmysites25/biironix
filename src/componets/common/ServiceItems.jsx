    ...
    <div className="py-[5rem] bg-backgroundcolor text-primarytextcolor">
      ...
      >
        ...
        <p data-aos="fade-up" className="desc max-w-[50rem]">
          At BIIRONIX TECH, we’re dedicated to crafting transformative
                ...
                <div className="rounded-lg bg-white hover:bg-custom-gradient p-5 flex flex-col justify-between items-start text-start h-full gap-4">
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="flex items-center justify-center w-12 h-12 rounded-full bg-red-100 text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300">
